    ...
    if (existingUser) {
      ...
      setTimeout(() => {
        addBotMessage(
          ...
          "مرحبًا بك في عالم التنجيم الشخصي!\n\n" +
          "هذا التطبيق يقدم لك:\n" +
          "• قراءات فلكية مخصصة بناءً على بياناتك الشخصية 🔮\n" +
          "• توقعات يومية دقيقة لكل برج ✨\n" +
          "• إمكانية اختيار اللهجة العربية المفضلة لديك 🗣️\n" +
          "• إرشادات روحية وفلكية للحب والعمل والصحة 💫\n\n" +
          "للبدء، نحتاج إلى معلومات ميلادك لتقديم قراءة فلكية دقيقة.\n" +
          "اكتب /start الآن للبدء برحلتك الفلكية! ✨🌟"
        );
      }, 500);
    }
  }, []);
